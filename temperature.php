...
if (isset($_POST['submit'])) {
  ...
  $islem = $db->prepare("INSERT INTO temperature(girilen,nerden,sonuc,nereye,ip_adresi,tarih) Values (?,?,?,?,?,?)");
...
<body>
  ...
  <div id="main-content">
    ...
    <?php
    $cevaplar = $db->prepare("SELECT * FROM temperature GROUP BY id DESC");
    $cevaplar->execute();
